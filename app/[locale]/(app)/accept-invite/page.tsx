        ...
        {step === "done" ? (
          ...
          <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-300">
            ...
            <form onSubmit={handleVerify} className="space-y-4">
              <FormField label={t("emailLabel")} htmlFor="invite-email" required tooltip={t("emailTooltip")}>
                <Input
                  id="invite-email"
                  type="email"
              ...
              <FormField label={t("otpLabel")} htmlFor="invite-otp" required constraint={t("otpConstraint")}>
                <Input
                  id="invite-otp"
                  type="text"
                  inputMode="numeric"
